...
raket_a.color('purple')
raket_a.penup()
raket_a.goto(-350, 0)
raket_a.shapesize(8, 2)
...
yazi.penup()
yazi.goto(0, 260)
yazi.write("Oyuncu KimSeokJin:0   Oyuncu JoenJungKook:0", align='center', font=('Courier', 20, 'bold'))
yazi.hideturtle()
puan_a = 0
puan_b = 0
...
while True:
    ...
    if ball.xcor()>390:
        ...
        puan_a = puan_a + 1
        yazi.clear()
        yazi.write("Oyuncu KimSeokJin:{}   Oyuncu JoenJungKook:{}".format(puan_a, puan_b), align='center', font=('Courier', 20, 'bold'))
    if ball.xcor()<-390:
        winsound.PlaySound('bounce.wav', winsound.SND_ASYNC)
        ball.goto(0, 0)
        ball.dx = ball.dx * -1
